...
int main(int argc, char **argv) {
    ...
    op_openmvg.parse();
    meshac::SfMData sfm_data = op_openmvg.getSfmData();
    ...
    auto estimator = new meshac::WorstEigenvalueVarianceEstimator(&accuracyModel, sfm_data.points_);   // E-criterion
    meshac::VertexColorerPtr meshColorer = new meshac::VertexColorer(color_file, estimator);
