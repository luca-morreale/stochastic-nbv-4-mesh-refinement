...
int main(int argc, char **argv) {
    ...
    meshac::InvariantAccuracyModel accuracyModel(sfm_data, pathPrefix, pixelSize);
    // meshac::ComputerVisionAccuracyModel accuracyModel(sfm_data, pathPrefix, pixelSize);
    meshColorer = new meshac::VertexColorer(color_file, new meshac::WorstEigenvalueVarianceEstimator(&accuracyModel, sfm_data.points_));
