...
int main(int argc, char **argv) {
    ...
    opview::SpaceBounds bounds(glm::vec3(-10, -10, 1.5), glm::vec3(10, 10, 1.5));
    
    opview::OrientationHierarchicalConfiguration config(DEPTH, DISCRETE_LABELS, bounds, {30, 30, 20, 20, 10}, 1.5708);
