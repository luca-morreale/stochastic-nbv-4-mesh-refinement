...
int main(int argc, char **argv) {
    ...
    std::string outputEvaluation = "output/output_evaluation_emulate.txt";
    std::string command;
    ...
    std::string basicPosesFilename = "building_poses_cam.txt";
    std::string baseImageFolder = "images";
    std::string intrinsicParams = "959.9965;0;960;0;-959.9965;540;0;0;1";
    
    cameval::SequentialEvaluator eval(convertedPosesFile, groundTruthFilename, basicPosesFilename, baseImageFolder, intrinsicParams, outputEvaluation, basicPovFile);
    eval.evaluate();
